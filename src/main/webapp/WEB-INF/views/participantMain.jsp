...
<head>
    ...
    <script defer src="/js/participant_main_0.0.6.js"></script>
    ...
    <!-- 추천 채용정보 CSS & JS -->
    <link rel="stylesheet" href="/css/participantCss/recommend-modal_0.0.6.css">
    <script defer src="/js/recommend-modal_0.0.9.js"></script>
