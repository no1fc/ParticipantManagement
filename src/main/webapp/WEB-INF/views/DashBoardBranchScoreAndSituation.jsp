...
<head>
    ...
    <!-- 실적 정보 Dfault 디자인 -->
    <!-- 실적 정보 Dfault 디자인 -->
    <link rel="stylesheet" href="/css/participantCss/DashBoardBranchScoreAndSituation_0.0.1.css" />
    <link rel="stylesheet" href="/css/participantCss/DashBoardBranchScoreAndSituation_0.0.2.css" />
            ...
            <div class="container-fluid dashboard-container">
                ...
                <c:if test="${IS_BRANCH_MANAGER || IS_MANAGER}">
                    <div class="control-panel fade-in">
                        <div class="row">
                            <div class="col-12">
                                <h6 class="control-panel-title"><i class="bi bi-sliders"></i> 실적 조회 설정</h6>
                            </div>
                        </div>
                ...
                <!-- 로딩 영역 -->
                <div id="loadingScoreChartDiv" class="chart-container modern-loader is-hidden">
                    <div class="modern-loader-text">실적 정보를 불러오는 중입니다</div>
                    <div class="loader"></div>
                </div>

                <!-- 실적 테이블 영역 -->
                <div id="performanceTableDiv" class="modern-table-container is-hidden">
                ...
                <!-- 개별 로딩 영역 -->
                <div id="loadingDiv" class="chart-container modern-loader is-hidden">
                ...
                <div id="detail-chart-grid" class="chart-grid">
                    <div class="card-modern">
                        <div class="card-header border-0">
                            <h3 class="card-title"><i class="bi bi-trophy-fill text-warning me-2"></i>총점 현황</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card-modern">
                        <div class="card-header border-0">
                            <h3 class="card-title"><i class="bi bi-people-fill text-success me-2"></i>취업자 점수</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card-modern">
                        <div class="card-header border-0">
                            <h3 class="card-title"><i class="bi bi-briefcase-fill text-info me-2"></i>알선 점수</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card-modern">
                        <div class="card-header border-0">
                            <h3 class="card-title"><i class="bi bi-shield-fill-check text-primary me-2"></i>고용유지 점수</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card-modern">
                        <div class="card-header border-0">
                            <h3 class="card-title"><i class="bi bi-speedometer2 text-danger me-2"></i>조기취업 점수</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card-modern">
                        <div class="card-header border-0">
                            <h3 class="card-title"><i class="bi bi-star-fill text-purple me-2"></i>나은일자리 점수</h3>
                        </div>
                        <div class="card-body">
        ...
        function fetchPerformanceContract(conditionFlag) {
            return new Promise((resolve, reject) => {
                ...
                fetch('scoreBranchPerformanceGraphAjax.login', {
                    ...
                    body: JSON.stringify({
                        dashBoardStartDate: $dashBoardStartDateInput.val(),//EX: '2024-11-01',
